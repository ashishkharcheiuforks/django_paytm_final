...
urlpatterns = [
    ...
    url(
        r"^registration/sign-out",
        auth_views.LogoutView.as_view(),
        {"next_page": "/"},
        name="registration-sign-out",
    ),
    url(
        r"^registration/sign-up",
        views.registration_sign_up,
        name="registration-sign-up",
    ),
    url(r"^registration/$", views.registration_home, name="registration-home"),
    url(
        r"^registration/account/$",
        views.registration_account,
        name="registration-account",
    ),
    url(r"^registration/meal/$", views.registration_meal, name="registration-meal"),
    url(r"^registration/drink/$", views.registration_drink, name="registration-drink"),
    url(
        r"^registration/meal/add/$",
        views.registration_add_meal,
        name="registration-add-meal",
    ),
    url(
        r"^registration/drink/add/$",
        views.registration_add_drink,
        name="registration-add-drink",
    ),
    url(
        r"^registration/meal/edit/(?P<meal_id>\d+)/$",
        views.registration_edit_meal,
        name="registration-edit-meal",
    ),
    url(
        r"^registration/drink/edit/(?P<drink_id>\d+)/$",
        views.registration_edit_drink,
        name="registration-edit-drink",
    ),
    url(r"^registration/order/$", views.registration_order, name="registration-order"),
    url(
        r"^registration/report/$", views.registration_report, name="registration-report"
    ),
    url(
        r"^api/social/revoke-token/?$", MyRevokeTokenView.as_view(), name="revoke_token"
    ),
    url(
        r"^api/registration/order/notification/(?P<last_request_time>.+)/$",
        apis.registration_order_notification,
    ),
    ##For authentication
