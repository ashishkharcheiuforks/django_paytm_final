...
from deploytodotaskerapp.models import Meal, Order, Driver, Customer
...
def registration_add_meal(request):
    ...
    return render(request, "registration/add_meal.html", {"form": form})
...
def registration_report(request):
    ...
    return render(
        request,
        "registration/report.html",
        {"revenue": revenue, "orders": orders, "meal": meal, "customer": customer},
    )
